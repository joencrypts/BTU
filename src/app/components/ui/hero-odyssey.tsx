  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          {/* Removed FeatureItem technology texts */}
        </motion.div>
        {/* Main hero content */}
        <motion.div
          variants={containerVariants}
        ...
        >
          {/* Removed 'Join us for free world' button */}
          <motion.h1
            variants={itemVariants}
            className="text-5xl md:text-7xl font-semi-bold mb-2"
          >
            Brand Top Up
          </motion.h1>
          <motion.h2
          ...
          >
            Elevate your brand with data-driven strategies, bold designs, and digital experiences that leave a lasting impact.
          </motion.p>
          {/* Removed 'Discover Those Worlds' button */}
        </motion.div>
      </div>
      {/* Background elements */}
      <motion.div
      ...
      >
        ...
        {/* Soft black blur at bottom for smooth transition */}
        <div className="pointer-events-none absolute bottom-0 left-0 w-full h-80 bg-gradient-to-b from-transparent via-black/80 to-black" />
      </motion.div>
    </div>
  );
};
